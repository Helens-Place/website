---
title: Dr Helen Ross, dyslexia specialist and researcher in Trowbridge
description: >-
  Dyslexia assessments, teacher training and research from Dr Helen Ross, a
  published academic and qualified diagnostic assessor based in Trowbridge,
  Wiltshire.
...
doors:
  ...
  - audience: schools
    ...
    body: >-
      Practical, research-grounded INSET and bespoke CPD on dyslexia,
      dyscalculia and SEND, delivered in your setting and shaped around your
      staff, not a generic slide deck.
...
testimonials:
  - quote: >-
      ...
      report was comprehensive yet easy to understand for parents and teachers.
      Our school SENCo now recommends Helen to everyone.
    name: Alice
    role: Parent
    tone: families
  - quote: >-
      Incredibly hard-working, super knowledgeable and a real professional. One
      quality stood out through the whole project: her professional and personal
      integrity.
    name: Michael Druker
...
bookBand:
  ...
  body: >-
    A practical, uplifting guide to supporting dyslexic children from Early
    Years to age 18, with evidence-based strategies, real case studies and
    reflection prompts. A second book is on the way.
  cta:
